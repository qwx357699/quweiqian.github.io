...
<img src="https://qwq9527.gitee.io/resource/imgs/20201026171519.png" alt="image-20201026171519761" style="zoom:50%;" />
...
<img src="https://qwq9527.gitee.io/resource/imgs/20201026173949.png" alt="image-20201026173949874" style="zoom: 40%;" />

除了兼容`vue2`的配置式注入，`vue3`在`composition api`中添加了`provide`和`inject`方法，可以在`setup`函数中注入和使用数据

<img src="https://qwq9527.gitee.io/resource/imgs/20201026174039.png" alt="image-20201026174039594" style="zoom:40%;" />
